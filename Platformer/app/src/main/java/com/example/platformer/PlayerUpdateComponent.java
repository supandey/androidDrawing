...
public class PlayerUpdateComponent implements UpdateComponent {
    ...
    // How long a jump lasts. Further subdivided into up time and down time, later
    ...
    public void update(long fps, Transform t, Transform playerTransform) {
        ...
        // Check if jump was triggered by player and if player is NOT ALREADY jumping or falling
        // Don't want jumping in mid air. If you want double jump (or triple etc.) allow the jump when not grounded,
        // and count the number of non-grounded jumps and disallow jump when your preferred limit is reached
