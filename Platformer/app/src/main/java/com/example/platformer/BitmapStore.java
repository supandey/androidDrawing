...
public class BitmapStore {
    ...
    private BitmapStore(Context c) {
        ...
        // Put a default bitmap in each of the maps to return in case a bitmap doesn't exist
        addBitmap(c,
                "death_visible",
                new PointF(1, 1),
                128,
    ...
    static void addBitmap(Context c, String bitmapName, PointF objectSize, int pixelsPerMetre, boolean needReversed) {
        Bitmap bitmap;
