...
public class GameEngine extends SurfaceView implements Runnable, GameEngineBroadcaster, EngineController{
    ...
    private CopyOnWriteArrayList<InputObserver> mInputObservers = new CopyOnWriteArrayList();
    ...
    public void startNewLevel() {
        ...
        // Clear all the observers and add the UI observer back. When we call buildGameObjects the player's observer will be added too
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        for (InputObserver o : mInputObservers) {
