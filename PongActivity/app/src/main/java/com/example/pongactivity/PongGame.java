...
public class PongGame extends SurfaceView implements Runnable {
    ...
    // This volatile vaiable can be accessed from inside and outside the thread
    ...
    private void startNewGame(){
        // Put the ball back to the starting position. Rest the score and the player's chances
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction() & MotionEvent.ACTION_MASK) {
            ...
            // The player lifted their finger from anywhere on screen (dont handle multiple fingers)
