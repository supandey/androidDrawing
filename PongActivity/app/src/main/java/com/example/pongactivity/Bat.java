...
public class Bat {
    ...
    // Keeps track of if an how the ball is moving. Starting with STOPPED
    ...
    Bat(int sx, int sy) {
        ...
        // Configure the speed of the bat. This code means the bat can cover the width of the screen in 1 second
        mBatSpeed = mScreenX;
    }
